...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { address: @employer.address, contact_no: @employer.contact_no, first_name: @employer.first_name, is_deleted: @employer.is_deleted, last_name: @employer.last_name, middle_name: @employer.middle_name }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { address: @employer.address, contact_no: @employer.contact_no, first_name: @employer.first_name, is_deleted: @employer.is_deleted, last_name: @employer.last_name, middle_name: @employer.middle_name }
    assert_redirected_to employer_path(assigns(:employer))
  end
